...
VL_ATTR_COLD void Vnext_hold_tb___024unit___ctor_var_reset(Vnext_hold_tb___024unit* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    Vnext_hold_tb__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+        Vnext_hold_tb___024unit___ctor_var_reset\n"); );
}
