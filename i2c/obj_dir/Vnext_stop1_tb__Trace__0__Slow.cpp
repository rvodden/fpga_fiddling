...
VL_ATTR_COLD void Vnext_stop1_tb___024root__trace_init_sub__TOP____024unit__0(Vnext_stop1_tb___024root* vlSelf, VerilatedVcd* tracep);

VL_ATTR_COLD void Vnext_stop1_tb___024root__trace_init_sub__TOP__0(Vnext_stop1_tb___024root* vlSelf, VerilatedVcd* tracep) {
    if (false && vlSelf) {}  // Prevent unused
    Vnext_stop1_tb__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vnext_stop1_tb___024root__trace_init_sub__TOP__0\n"); );
    // Init
    const int c = vlSymsp->__Vm_baseCode;
    // Body
    tracep->pushPrefix("$unit", VerilatedTracePrefixType::SCOPE_MODULE);
    Vnext_stop1_tb___024root__trace_init_sub__TOP____024unit__0(vlSelf, tracep);
    tracep->popPrefix();
    tracep->pushPrefix("next_stop1_tb", VerilatedTracePrefixType::SCOPE_MODULE);
...
VL_ATTR_COLD void Vnext_stop1_tb___024root__trace_init_sub__TOP____024unit__0(Vnext_stop1_tb___024root* vlSelf, VerilatedVcd* tracep) {
    if (false && vlSelf) {}  // Prevent unused
    Vnext_stop1_tb__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vnext_stop1_tb___024root__trace_init_sub__TOP____024unit__0\n"); );
    // Init
    const int c = vlSymsp->__Vm_baseCode;
    // Body
...
VL_ATTR_COLD void Vnext_stop1_tb___024root__trace_init_top(Vnext_stop1_tb___024root* vlSelf, VerilatedVcd* tracep) {
    if (false && vlSelf) {}  // Prevent unused
    Vnext_stop1_tb__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vnext_stop1_tb___024root__trace_init_top\n"); );
    // Body
    Vnext_stop1_tb___024root__trace_init_sub__TOP__0(vlSelf, tracep);
}

VL_ATTR_COLD void Vnext_stop1_tb___024root__trace_const_0(void* voidSelf, VerilatedVcd::Buffer* bufp);
VL_ATTR_COLD void Vnext_stop1_tb___024root__trace_full_0(void* voidSelf, VerilatedVcd::Buffer* bufp);
void Vnext_stop1_tb___024root__trace_chg_0(void* voidSelf, VerilatedVcd::Buffer* bufp);
void Vnext_stop1_tb___024root__trace_cleanup(void* voidSelf, VerilatedVcd* /*unused*/);

VL_ATTR_COLD void Vnext_stop1_tb___024root__trace_register(Vnext_stop1_tb___024root* vlSelf, VerilatedVcd* tracep) {
    if (false && vlSelf) {}  // Prevent unused
    Vnext_stop1_tb__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vnext_stop1_tb___024root__trace_register\n"); );
    // Body
    tracep->addConstCb(&Vnext_stop1_tb___024root__trace_const_0, 0U, vlSelf);
    tracep->addFullCb(&Vnext_stop1_tb___024root__trace_full_0, 0U, vlSelf);
    tracep->addChgCb(&Vnext_stop1_tb___024root__trace_chg_0, 0U, vlSelf);
    tracep->addCleanupCb(&Vnext_stop1_tb___024root__trace_cleanup, vlSelf);
}

VL_ATTR_COLD void Vnext_stop1_tb___024root__trace_const_0_sub_0(Vnext_stop1_tb___024root* vlSelf, VerilatedVcd::Buffer* bufp);

VL_ATTR_COLD void Vnext_stop1_tb___024root__trace_const_0(void* voidSelf, VerilatedVcd::Buffer* bufp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vnext_stop1_tb___024root__trace_const_0\n"); );
    // Init
    Vnext_stop1_tb___024root* const __restrict vlSelf VL_ATTR_UNUSED = static_cast<Vnext_stop1_tb___024root*>(voidSelf);
    Vnext_stop1_tb__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    // Body
    Vnext_stop1_tb___024root__trace_const_0_sub_0((&vlSymsp->TOP), bufp);
}

VL_ATTR_COLD void Vnext_stop1_tb___024root__trace_const_0_sub_0(Vnext_stop1_tb___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    if (false && vlSelf) {}  // Prevent unused
    Vnext_stop1_tb__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vnext_stop1_tb___024root__trace_const_0_sub_0\n"); );
    // Init
...
VL_ATTR_COLD void Vnext_stop1_tb___024root__trace_full_0_sub_0(Vnext_stop1_tb___024root* vlSelf, VerilatedVcd::Buffer* bufp);

VL_ATTR_COLD void Vnext_stop1_tb___024root__trace_full_0(void* voidSelf, VerilatedVcd::Buffer* bufp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vnext_stop1_tb___024root__trace_full_0\n"); );
    // Init
    Vnext_stop1_tb___024root* const __restrict vlSelf VL_ATTR_UNUSED = static_cast<Vnext_stop1_tb___024root*>(voidSelf);
    Vnext_stop1_tb__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    // Body
    Vnext_stop1_tb___024root__trace_full_0_sub_0((&vlSymsp->TOP), bufp);
}

VL_ATTR_COLD void Vnext_stop1_tb___024root__trace_full_0_sub_0(Vnext_stop1_tb___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    if (false && vlSelf) {}  // Prevent unused
    Vnext_stop1_tb__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vnext_stop1_tb___024root__trace_full_0_sub_0\n"); );
    // Init
    uint32_t* const oldp VL_ATTR_UNUSED = bufp->oldp(vlSymsp->__Vm_baseCode);
    // Body
    bufp->fullSData(oldp+1,(vlSelf->next_stop1_tb__DOT__ctr_reg),16);
    bufp->fullCData(oldp+2,(((0xffffU == (IData)(vlSelf->next_stop1_tb__DOT__ctr_reg))
                              ? 6U : 5U)),4);
    bufp->fullSData(oldp+3,(((0xffffU == (IData)(vlSelf->next_stop1_tb__DOT__ctr_reg))
                              ? 0U : (0xffffU & ((IData)(1U) 
                                                 + (IData)(vlSelf->next_stop1_tb__DOT__ctr_reg))))),16);
}
