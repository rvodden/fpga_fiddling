...
VL_ATTR_COLD void Vnext_stop1_tb___024unit___ctor_var_reset(Vnext_stop1_tb___024unit* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    Vnext_stop1_tb__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+        Vnext_stop1_tb___024unit___ctor_var_reset\n"); );
}
